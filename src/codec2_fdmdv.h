...
CODEC2_API struct FDMDV *fdmdv_create(int Nc);
CODEC2_API void fdmdv_destroy(struct FDMDV *fdmdv_state);
CODEC2_API void fdmdv_use_old_qpsk_mapping(struct FDMDV *fdmdv_state);
CODEC2_API int fdmdv_bits_per_frame(struct FDMDV *fdmdv_state);
CODEC2_API float fdmdv_get_fsep(struct FDMDV *fdmdv_state);
CODEC2_API void fdmdv_set_fsep(struct FDMDV *fdmdv_state, float fsep);

CODEC2_API void fdmdv_mod(struct FDMDV *fdmdv_state, COMP tx_fdm[],
                           int tx_bits[], int *sync_bit);
CODEC2_API void fdmdv_demod(struct FDMDV *fdmdv_state, int rx_bits[],
                             int *reliable_sync_bit, COMP rx_fdm[], int *nin);

CODEC2_API void fdmdv_get_test_bits(struct FDMDV *fdmdv_state, int tx_bits[]);
CODEC2_API int fdmdv_error_pattern_size(struct FDMDV *fdmdv_state);
CODEC2_API void fdmdv_put_test_bits(struct FDMDV *f, int *sync,
                                     short error_pattern[], int *bit_errors,
                                     int *ntest_bits, int rx_bits[]);

CODEC2_API void fdmdv_get_demod_stats(struct FDMDV *fdmdv_state,
                                       struct MODEM_STATS *stats);

CODEC2_API void fdmdv_8_to_16(float out16k[], float in8k[], int n);
CODEC2_API void fdmdv_8_to_16_short(short out16k[], short in8k[], int n);
CODEC2_API void fdmdv_16_to_8(float out8k[], float in16k[], int n);
CODEC2_API void fdmdv_16_to_8_short(short out8k[], short in16k[], int n);
CODEC2_API void fdmdv_8_to_48(float out48k[], float in8k[], int n);
CODEC2_API void fdmdv_48_to_8(float out8k[], float in48k[], int n);
CODEC2_API void fdmdv_8_to_48_short(short out48k[], short in8k[], int n);
CODEC2_API void fdmdv_48_to_8_short(short out8k[], short in48k[], int n);

CODEC2_API void fdmdv_freq_shift(COMP rx_fdm_fcorr[], COMP rx_fdm[],
                                  float foff, COMP *foff_phase_rect, int nin);

/* debug/development function(s) */

CODEC2_API void fdmdv_dump_osc_mags(struct FDMDV *f);
CODEC2_API void fdmdv_simulate_channel(float *sig_pwr_av, COMP samples[],
                                        int nin, float target_snr);
